...
<h2 class="section__title" style="margin:2.2em 0 0.4em">Teaching</h2>

<div class="entry">
  <div class="entry__media">
    {% include video.html src="teaching" caption="Coursework from AuE8230: simulation in ROS Noetic, then the same behaviour deployed on a TurtleBot3 Burger." %}
  </div>
  <div>
    <h3 class="entry__title">Graduate robotics courses, Clemson University</h3>
...
<h2 class="section__title" style="margin:2.6em 0 0.4em">Outreach and talks</h2>

<div class="entry entry--reverse">
  <div class="entry__media">
    <img src="/images/innoventure.jpg" alt="Presenting at the Innoventure Futures Festival in Greenville, South Carolina" loading="lazy">
  </div>
  <div>
    <h3 class="entry__title">Innoventure Futures Festival</h3>
...
<div class="entry">
  <div class="entry__media">
    <img src="/images/autotechday.jpg" alt="Demonstrating autonomous robots at Auto Tech Day" loading="lazy">
  </div>
  <div>
    <h3 class="entry__title">Auto Tech Day</h3>
...
<h2 class="section__title" style="margin:2.6em 0 0.4em">Leadership</h2>

<div class="entry entry--reverse">
  <div class="entry__media">
    <img src="/images/ras.jpg" alt="IEEE Robotics and Automation Society Student Activities Committee" loading="lazy">
  </div>
  <div>
    <h3 class="entry__title">Conference Co-Chair, IEEE RAS Student Activities Committee</h3>
