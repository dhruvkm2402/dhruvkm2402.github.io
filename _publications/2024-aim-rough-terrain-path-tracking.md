...
A model-based controller combined with a deep reinforcement learning policy for path tracking
across diverse terrains, with rough-terrain assets authored in Blender and exported to OpenUSD.
98.5% precision on unseen real-world tracks.
